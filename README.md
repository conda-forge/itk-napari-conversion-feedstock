...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/itk-napari-conversion-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15303&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/itk-napari-conversion-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `itk-napari-conversion` can be installed with:

```
conda install itk-napari-conversion
```

It is possible to list all of the versions of `itk-napari-conversion` available on your platform with:
